...
plugins=(archlinux git-flow-avh extract rsync catimg docker sudo composer yarn)
...
if [ -f '/home/george/google-cloud-sdk/path.zsh.inc' ]; then source '/home/george/google-cloud-sdk/path.zsh.inc'; fi
